...
class Test_dict_frequency:
    ...
    def test_dictionary_key(self):
        ...
        assert (res) == {
            ...
            3: [{"char": "l", "frequency": 3}],
            2: [{"char": "o", "frequency": 2}],
        }
    ...
    def test_leaf_path(self):
        ...
        assert res == {
            "i": {"frequency": 12, "path_binary": "00"},
            "s": {"frequency": 13, "path_binary": "01"},
            "e": {"frequency": 15, "path_binary": "10"},
            "u": {"frequency": 4, "path_binary": "1100"},
            "t": {"frequency": 1, "path_binary": "11010"},
            "o": {"frequency": 3, "path_binary": "11011"},
            "a": {"frequency": 10, "path_binary": "111"},
        }
