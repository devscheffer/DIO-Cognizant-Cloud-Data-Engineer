...
cwd = getcwd()
path.append(cwd)
from src.function.create_dict_binary_to_string import fn_create_dict_binary_to_string
from src.create_node import cls_node
from src.function.add_tree_into_dict import fn_add_tree_into_dict
from src.function.create_pair import fn_create_pair
from src.function.create_binary_tree_huffman import fn_create_binary_subtree
